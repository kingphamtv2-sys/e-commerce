@php
    $menuItems = [
        ...
        ['label' => __('admin.menu.currencies'), 'href' => '#', 'pattern' => 'admin.currencies*', 'icon' => 'banknote'],
        ['label' => __('admin.menu.tax_classes'), 'href' => '#', 'pattern' => 'admin.tax-classes*', 'icon' => 'receipt'],
        ['label' => __('admin.menu.tax_rates'), 'href' => '#', 'pattern' => 'admin.tax-rates*', 'icon' => 'percent'],
        ['label' => __('admin.menu.categories'), 'href' => '#', 'pattern' => 'admin.categories*', 'icon' => 'folder'],
        ['label' => __('admin.menu.products'), 'href' => '#', 'pattern' => 'admin.products*', 'icon' => 'cube'],
        ['label' => __('admin.menu.inventory'), 'href' => '#', 'pattern' => 'admin.inventory*', 'icon' => 'archive'],
