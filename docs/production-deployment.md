...
Project có database queue table và `QUEUE_CONNECTION=database`, nhưng tại Task 28 chưa có class `ShouldQueue`; queue worker chưa bắt buộc cho luồng hiện tại.
